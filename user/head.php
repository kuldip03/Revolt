    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="" key="t-apps">
                    <a href="dashboard" key="t-error-500">Dashboard</a>
                </li>  
                <li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="far fa-user"></i> Show Profile</a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="profile" key="t-error-500">Show Profile</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="fas fa-user-edit"></i> Update Profile</a>
                    <ul class="sub-menu" aria-expanded="false">
