...
<!-- Form -->
                                <div  class="bg bg-danger" style="margin-top: 5px;"><h4 class="text-white " style="margin-left: 5px;">Post New Video</h4></div>
                                    <form class="box" action="add_video_post_sql.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group m-1">
                                            <label for="exampleInputPassword1">Post Video</label>
                                            <input type="file" name="fileToUpload2" class="form-control" required>
                                        </div>
                                        <!--                                    <div class="form-group m-1">
                                                                                <label for="exampleInputPassword1">Video Image Icon </label>
